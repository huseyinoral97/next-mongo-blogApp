...
const CategoryList = ({ withImage }) => {
  return <div className={withImage ? "container mx-auto max-md:p-4" : ""}>
    ...
    <div className="grid max-md:grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-5">
      <div className="flex justify-center items-center p-3 bg-blue-500 rounded-md cursor-pointer">
        {withImage && <Image src="/style.png" alt="Style Picture" width={50} height={50} className="rounded-full w-7 h-7 mr-3" />}
      ...
      <div className="flex justify-center items-center p-3 bg-red-500 rounded-md cursor-pointer">
        {withImage && <Image src="/fashion.png" alt="Style Picture" width={50} height={50} className="rounded-full w-7 h-7 mr-3" />}
      ...
      <div className="flex justify-center items-center p-3 bg-green-500 rounded-md cursor-pointer">
        {withImage && <Image src="/food.png" alt="Style Picture" width={50} height={50} className="rounded-full w-7 h-7 mr-3" />}
      ...
      <div className="flex justify-center items-center p-3 bg-purple-500 rounded-md cursor-pointer">
        {withImage && <Image src="/travel.png" alt="Style Picture" width={50} height={50} className="rounded-full w-7 h-7 mr-3" />}
      ...
      <div className="flex justify-center items-center p-3 bg-orange-500 rounded-md cursor-pointer">
        {withImage && <Image src="/culture.png" alt="Style Picture" width={50} height={50} className="rounded-full w-7 h-7 mr-3" />}
      ...
      <div className="flex justify-center items-center p-3 bg-yellow-500 rounded-md cursor-pointer">
        {withImage && <Image src="/coding.png" alt="Style Picture" width={50} height={50} className="rounded-full w-7 h-7 mr-3" />}
